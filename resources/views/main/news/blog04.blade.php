        ...
        <div class="container">
            ...
            <div class="row left">
                <ol class="breadcrumb ">
                    ...
                    <li class="breadcrumb-item active">@lang('web.blog04_date')</li>
                </ol>
            </div>
            <!-- Blog -->
                ...
                <div class="post-item">
                    <div class="post-item-wrap">
                        ...
                        <div><a href="#!"><img class="card-img-top"
                                    src="assets/images/blog/foto programul de lucru inegal in pandemie 800.png" alt="..."
                                    width="100%" /></a></div></br>

                        <div class="post-item-description">
                            <h2>@lang('web.blog04_title')</h2>
                            <div class="post-meta">
                            ...
                            @includeFirst(
                                [
                                    'main.news.partials.blog04_' . app()->getLocale(),
                                    'main.news.partials.blog04_ro',
                                ]
                            )
