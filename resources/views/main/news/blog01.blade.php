        ...
        <div class="container">
            ...
            <div class="row left">
                <ol class="breadcrumb ">
                    ...
                    <li class="breadcrumb-item active">@lang('web.blog01_date')</li>
                </ol>
            </div>
                ...
                <div class="post-item">
                    <div class="post-item-wrap">
                        ...
                        <div><a href="#!"><img class="card-img-top"
                                    src="assets/images/blog/foto_muncitori_infrastructura_750.png" alt="..."
                                    width="100%" /></a></div></br>

                        <div class="post-item-description">
                            <h2>@lang('web.blog01_title')</h2>
                            <div class="post-meta">
                            ...
                            @includeFirst(
                                [
                                    'main.news.partials.blog01_' . app()->getLocale(),
                                    'main.news.partials.blog01_ro',
                                ]
                            )
