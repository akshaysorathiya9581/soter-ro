        ...
        <div class="container">
            ...
            <div class="row left">
                <ol class="breadcrumb ">
                    ...
                    <li class="breadcrumb-item active">@lang('web.blog02_date')</li>
                </ol>
            </div>
                ...
                <div class="post-item">
                    <div class="post-item-wrap">
                        ...
                        <div class="post-item-description">
                            ...
                            @includeFirst(
                                [
                                    'main.news.partials.blog02_' . app()->getLocale(),
                                    'main.news.partials.blog02_ro',
                                ]
                            )
