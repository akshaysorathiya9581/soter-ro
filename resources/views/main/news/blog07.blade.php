        ...
        <div class="container">
            ...
            <div class="row left">
                <ol class="breadcrumb ">
                    ...
                    <li class="breadcrumb-item active">@lang('web.blog07_date')</li>
                </ol>
            </div>
            <!-- Blog -->
                ...
                <div class="post-item">
                    <div class="post-item-wrap">
                        ...
                        <div><a href="#!"><img class="card-img-top"
                                    src="assets/images/blog/foto formarea profesionala continua.png" alt="..."
                                    width="100%" /></a></div></br>

                        <div class="post-item-description">
                            <h2>@lang('web.blog07_title')</h2>
                            <div class="post-meta">
                            ...
                            @includeFirst(
                                [
                                    'main.news.partials.blog07_' . app()->getLocale(),
                                    'main.news.partials.blog07_ro',
                                ]
                            )
