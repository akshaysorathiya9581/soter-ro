        ...
        <div class="container">
            ...
            <div class="row left">
                <ol class="breadcrumb ">
                    ...
                    <li class="breadcrumb-item active">@lang('web.blog03_date')</li>
                </ol>
            </div>
            <!-- Blog -->
                ...
                <div class="post-item">
                    <div class="post-item-wrap">
                        ...
                        <div class="post-item-description">
                            ...
                            @includeFirst(
                                [
                                    'main.news.partials.blog03_' . app()->getLocale(),
                                    'main.news.partials.blog03_ro',
                                ]
                            )
