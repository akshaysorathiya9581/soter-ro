...
<header id="header" class="header-transparent">
    <div id="header-wrap">
        <div class="container">
            ...
            <!--LOGO-->
            <!-- <div id="logo">
                        <a href="@lang('route.acasa')" class="logo" data-dark-logo="img/soterlogo1.png">
                            <img src="img/soterlogo1.png" alt="Soter and Partners SRL">
                        </a>
                    </div> -->

            <div id="logo">
                <a href="@lang('route.acasa')" class="navbar-left"
                    data-dark-logo="{{ URL::asset('assets/Site/Presentation/img/soterlogonour_2.png') }}">
                    <div> <img class="fa" src="{{ URL::asset('assets/Site/Presentation/img/soterlogonour_2.png') }}"
                            alt="Soter and Partners SRL"> </div>
                </a>
            </div>
            <!--END: LOGO-->
                        ...
                        <ul class="main-menu nav nav-pills">
                            ...
                            <li class="dropdown"> <a href="#">@lang('web.despre_menu')<i class="fa fa-angle-down"></i>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu"><a href="@lang('route.grup')">@lang('web.grup_menu')</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="@lang('route.divizare2025')">@lang('web.divizare2025_menu')</a></li>
                                            <li><a href="@lang('route.componenta')">@lang('web.componenta_menu')</a></li>
                                        </ul>
                                    </li>
                            ...
                            <li class="dropdown"> <a href="#">@lang('web.servicii_menu')<i class="fa fa-angle-down"></i>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="@lang('route.e-transport')">@lang('web.transport_consultanta_menu')</a></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu"><a href="@lang('route.politica')">@lang('web.politica_conf_menu')</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="@lang('route.dezvaluire')">@lang('web.dezvaluire_menu')</a></li>
                                            <li><a href="@lang('route.subcontractanti')">@lang('web.subcontractanti_menu')</a></li>
                                        </ul>
                                    </li>
